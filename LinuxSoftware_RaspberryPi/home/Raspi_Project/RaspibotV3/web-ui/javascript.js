	...
	if (command[name] == 0) 
		{
			...
			{
				command[name] = 0;
				if (name=='ULTRASONIC') 	$('span.ULTRASONIC_button').html("O");
				if (name=='CAMERA') 		$('span.CAMERA_button').html("O");
				if (name=='DISTANCE') 		$('span.DISTANCE_button').html("O");
				if (name=='SPEED')			$('span.SPEED_button').html("O");
				if (name=='LED')			$('span.LED_button').html("O");
			}
	send();
	send();
}
